...
class Trainer:
    def __init__(
        ...
        num_classes = model.num_classes  # or specify manually if known
        ...
        self.train_loss = []
        self.val_loss = []
        self.train_acc = []  # ✅ Add this
        self.val_acc = []  # ✅ Add this
        self.best_model = None
    def _plot_metrics(self, output_path: str) -> None:
        """
    ...
    def train(
        ...
        self._plot_metrics(output_path)
